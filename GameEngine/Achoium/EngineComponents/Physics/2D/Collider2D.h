...
namespace ac
{
    ...
    {
    public:
        glm::vec2 offset; ///< Local position offset from entity's transform
         ...
         */
        explicit Collider2D(uint32_t _layer);
         ...
         */
        glm::vec2 GetWorldPosition(const Transform& transform) const;
